...
class BuildSearchResult extends StatelessWidget {
  const BuildSearchResult({super.key, required this.image, required this.name, required this.description, required this.price,});
            ...
            Stack(
              children: [
                ClipRRect(
                  ...
                  child: AspectRatio(
                    aspectRatio: 1.6/2,
                    child:CachedNetworkImage(imageUrl: "$baseUrl$image",
                    fit: BoxFit.fill,)
                  ),
                ),
                Positioned(
